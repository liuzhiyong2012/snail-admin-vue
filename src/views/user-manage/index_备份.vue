<template>
  <div class="front-user-list-ctn app-container">
    <div class="filter-container">
      ...
      <el-button v-waves class="search-item filter-item" type="primary" icon="el-icon-search" @click="handleFilter">
        搜索
      </el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="用户类型" class-name="status-col">
        <template slot-scope="{row}">
          <el-tag :type="row.roleType | roleTypeFilter">
            {{ row.roleType| roleTypeFilter }}
          </el-tag>
        </template>
      </el-table-column>
